...
public class Monde {
    ...
    public Monde(int minSecteurEau,int maxSecteurEau, int minMines, int maxMines){
        ...
        int i = 0;
        while (i < new Random().nextInt(maxSecteurEau-minSecteurEau)+minSecteurEau) {
        ...
        i = 0;
        while (i < new Random().nextInt(maxMines-minMines)+minMines) {
            int x = new Random().nextInt(10);
            int y = new Random().nextInt(10);
            if (getSecteur(x, y).getNature() == Nature.terre) {
        ...
        i = 0;
        while (i < new Random().nextInt(2)+1) {
            int x = new Random().nextInt(10);
            int y = new Random().nextInt(10);
